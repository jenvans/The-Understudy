...
import type { Substitute, DietaryFilter, SortOption, SearchResult } from '../types';
...
const localData = substitutionsData as SubstitutionEntry[];

function fuzzyMatch(searchTerm: string): SubstitutionEntry | undefined {
